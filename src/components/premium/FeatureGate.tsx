...
const FEATURE_LABELS: Record<Feature, string> = {
    ...
    chat_save_history: 'Save Chat History',
    chat_save_stranger: 'Save Stranger Contact',
    chat_auto_reconnect: 'Auto Reconnect',
    chat_reactions: 'Message Reactions',
    chat_nickname: 'Custom Nickname',
    chat_filter_gender: 'Filter by Gender',
    chat_filter_country: 'Filter by Country',
    chat_read_receipts: 'Read Receipts',
    chat_themes: 'Chat Themes',
    chat_translate: 'Auto Translate',
